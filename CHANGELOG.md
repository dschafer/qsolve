...
- Restore the terminal cursor when animation exits with an error.
...
[Unreleased]: https://github.com/dschafer/qsolve/compare/v1.1.0...HEAD
[1.1.0]: https://github.com/dschafer/qsolve/compare/v1.0.0...v1.1.0
